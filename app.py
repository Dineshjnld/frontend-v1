...
def fetch_instagram_profile(username, instaloader_username, instaloader_password):
    # Create an Instaloader instance with authentication
    ...
    try:
        ...
        st.write("Error: Instagram profile not found.")
        return None
...
def main():
   ...
   # Instagram credentials (replace with your own credentials)
    ...
    if search_button and username:
        ...
        user_input = fetch_instagram_profile(username, instaloader_username, instaloader_password)
